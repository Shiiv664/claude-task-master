...
/**
 * Generate system and user prompts for PRD parsing
 * @param {Object} params - Prompt generation parameters
 * @returns {Object} - { systemPrompt, userPrompt }
 */
function generatePrdPrompts({ numTasks, nextId, research, prdContent, prdPath }) {
...
// Export the shared prompt generation function
export { generatePrdPrompts };
